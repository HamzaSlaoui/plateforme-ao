...
const DocumentViewerPanel = ({ documents, onSelect, isVisible, onToggle }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 h-full w-80 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 shadow-2xl transform transition-transform duration-300 ease-in-out z-30 ${
